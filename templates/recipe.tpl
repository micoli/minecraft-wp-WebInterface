...
<table cellspacing="0" cellpadding="0" class="tablerecipe" style="background: #C6C6C6; border: outset 2px #999; padding: 6px; width:230px;height:148px">
	<tbody>
		<tr>
			...
			<td width="40" align="center" style="border: none; padding: 0" rowspan="3"><img width="32" height="27" src="{$datas.morg_wi_export_root}/../plugins/minecraft-wp-WebInterface/image/Grid_layout_Arrow_(small).png" alt="">
			</td>
			<td style="border: none; padding: 0" rowspan="3">
				<div style="position: relative">
					<img width="52" height="52" src="{$datas.morg_wi_export_root}/../plugins/minecraft-wp-WebInterface/image/Grid_layout_None_(small).png" alt="">
